...
GSM_keep <- c("GSM30418", "GSM30419", "GSM30420", "GSM30421", "GSM30422", "GSM30423", "GSM30424", "GSM30425", "GSM30426", "GSM30427", "GSM30428", "GSM30429", "GSM30430", "GSM30431", "GSM30432", "GSM30433", "GSM30434", "GSM30435", "GSM30436", "GSM30437", "GSM30438", "GSM30439", "GSM30440", "GSM30441", "GSM30442", "GSM30443", "GSM30444", "GSM30445", "GSM30446", "GSM30447","GSM30448", "GSM30449", "GSM30450", "GSM30451", "GSM30452", "GSM30453", "GSM30455", "GSM30456", "GSM30457","GSM30458")
...
heatmapGSM_filtr <- pheatmap(corMatrix_outliers,
         annotation_col = annotations,
         main = paste0(my_id, ' - Heatmap - Without outlier (GSM30454)'))
...
scale_color_manual(values=c("gold", "blue", "grey"))+
  labs(title=paste0(my_id, " - Volcano plot - 20 genes of tolerance (Baron et al. 2015)"))
```
...
full_results %>% 
  ...
  geom_vline(xintercept = c(-log2(1.5), log2(1.5)),
             linetype = "dashed")+
  scale_color_manual(values=c("gold", "blue", "grey"))+
  labs(title=paste0(my_id, " - Volcano plot - Top 20 genes "))
...
```{r}
filter(full_results, adj.P.Val < 0.05, abs(logFC) > log2(1.5)) %>%
...
heatmap_topN_genes <- pheatmap(gene_matrix_top,
     ...
     scale="row",
     annotation_col = annotations,
     main = paste0(my_id, ' - Heatmap - Top 20 genes'))
