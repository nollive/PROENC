...
gene_matrix_top <- exprs(data_filtr)[top_ids_of_interest,] %>%
  write_csv(path=paste0(my_id,"_filtered_results_topN_genes.csv"))
...
Baron_gene_matrix <- exprs(data_filtr)[Baron_ids_of_interest,] %>%
  write_csv(path=paste0(my_id,"_filtered_results_20_genes.csv"))
...
save_pheatmap_pdf(heatmap_6_genes, paste0(my_id,'_heatmap_20_genes.pdf'))
```
...
Danger_gene_matrix <- exprs(data_filtr)[Danger_ids_of_interest,] %>%
  write_csv(path=paste0(my_id,"_filtered_results_6_genes.csv"))
