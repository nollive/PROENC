...
##Affichage de la heatmpa des topN genes
CSA_HV_heatmap_topN_genes <- pheatmap(gene_matrix_top_DIFF,
...
save_pheatmap_pdf(SRL_HV_heatmap_200_genes, paste0('GSE_',my_id,'_SRL-HV_heatmap_20_genes.pdf'))
...
Danger_gene_names_SRL <-  filter(full_results,GENE_SYMBOL %in% Danger_genes) %>% 
  pull(GENE_SYMBOL)
