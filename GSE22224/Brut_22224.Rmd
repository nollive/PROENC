...
CSA_HV_heatmap_6_genes <- pheatmap(Baron_gene_matrix_CSA,
         labels_row = Baron_gene_names_CSA,
         annotation_col= annotations,
         scale="row")

save_pheatmap_pdf(CSA_HV_heatmap_6_genes, paste0('GSE_',my_id,'_CSA-HV_heatmap_20_genes.pdf'))
...
SRL_HV_heatmap_6_genes <- pheatmap(Baron_gene_matrix_SRL,
         labels_row = Baron_gene_names_SRL,
         annotation_col= annotations,
         scale="row")

save_pheatmap_pdf(SRL_HV_heatmap_6_genes, paste0('GSE_',my_id,'_SRL-HV_heatmap_20_genes.pdf'))
