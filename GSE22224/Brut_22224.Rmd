...
gene_matrix_top_CSA <- exprs(data_filtr)[top_ids_of_interest_CSA,] %>%
  write_csv(path=paste0(my_id,"_CSA-HV_filtered_results_topN_genes.csv"))
...
gene_matrix_top_SRL <- exprs(data_filtr)[top_ids_of_interest_SRL,] %>%
  write_csv(path=paste0(my_id,"_SRL-HV_filtered_results_topN_genes.csv"))
...
gene_matrix_top_DIFF <- exprs(data_filtr)[top_ids_of_interest_DIFF,] %>%
  write_csv(path=paste0(my_id,"_CSA-SRL_filtered_results_topN_genes.csv")) 
...
Baron_gene_matrix_CSA <- exprs(data_filtr)[Baron_ids_of_interest_CSA,]  %>%
  write_csv(path=paste0(my_id,"_CSA-HV_filtered_results_20_genes.csv"))
...
Baron_gene_matrix_SRL <- exprs(data_filtr)[Baron_ids_of_interest_SRL,] %>%
  write_csv(path=paste0(my_id,"_SRL-HV_filtered_results_20_genes.csv"))
...
Baron_gene_matrix_DIFF <- exprs(data_filtr)[Baron_ids_of_interest_DIFF,]  %>%
  write_csv(path=paste0(my_id,"_CSA-SRL_filtered_results_20_genes.csv"))
...
Danger_gene_matrix_CSA <- exprs(data_filtr)[Danger_ids_of_interest_CSA,] %>%
  write_csv(path=paste0(my_id,"_CSA-HV_filtered_results_6_genes.csv"))
...
Danger_gene_matrix_SRL <- exprs(data_filtr)[Danger_ids_of_interest_SRL,] %>%
  write_csv(path=paste0(my_id,"_SRL-HV_filtered_results_6_genes.csv"))
...
Danger_gene_matrix_DIFF <- exprs(data_filtr)[Danger_ids_of_interest_DIFF,] %>%
  write_csv(path=paste0(my_id,"_CSA-SRL_filtered_results_6_genes.csv"))
