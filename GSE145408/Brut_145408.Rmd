...
annotations = subset(sampleInfo, select = c(Group, Time))
...
pca_plot <- ggplot(
  ...
  labs(x = PC1_t , y = PC2_t, color = "Group") +
  theme_minimal()
...
## Differential Expression pour la comparaison Withdrawal vs Non Withdrawal
...
full_results %>% 
  ...
  geom_vline(xintercept = c(-fc_cutoff, fc_cutoff),
             linetype = "dashed")+
  scale_color_manual(values=c("gold","grey", "blue"))+
  labs(title=paste0(my_id, " - Volcano plot - Adjusted P.Value"))
ggsave(paste0(my_id,'-Volcano-plot-Adj-P-Val.pdf'))
...
ggsave(paste0(my_id,'-Volcano-plot-P-Val.pdf'))
```
...
data_WS <- DataSYMBOL[,index_WS]
data_WR <- DataSYMBOL[,index_WR]
data_NW <- DataSYMBOL[,index_NW]
dim(data_WS)
dim(data_WR)
dim(data_NW)
dim(data_filtr)
...
# lmFit
```{r}
fit_WS <- lmFit(data_WS, design_WS)
fit_WR <- lmFit(data_WR, design_WR)
fit_NW <- lmFit(data_NW, design_NW)
```
...
contrasts_WS <- makeContrasts(EffetTimeWS = TimeT1 - TimeT0,
                           levels=colnames(design_WS))
contrasts_WR <- makeContrasts(EffetTimeWR = TimeT1 - TimeT0,
                           levels=colnames(design_WR))
contrasts_NW <- makeContrasts(EffetTimeNW = TimeT1 - TimeT0,
...
full_results_WS %>%
  write_csv(path=paste0(my_id,"_WS-TIME_full_raw_results.csv"))
full_results_WR %>%
  write_csv(path=paste0(my_id,"_WR-TIME_full_raw_results.csv"))
full_results_NW %>%
  write_csv(path=paste0(my_id,"_NW-TIME_full_raw_results.csv"))
```



# Visualisation des resultats de la differencial expression
...
full_results_WS %>% 
  ...
  labs(title=paste0(my_id, " - Volcano plot - Comparaison WS - Time T0 vs T1 - Adj.P.Value"))
ggsave(paste0(my_id,'-Volcano-plot-Comparaison-WS-Time-Adj-P-Value.pdf'))
...
full_results_WS %>% 
  ...
  geom_vline(xintercept = c(-fc_cutoff, fc_cutoff),
             linetype = "dashed")+
  scale_color_manual(values=c("grey", "blue", "gold"))+
  labs(title=paste0(my_id, " - Volcano plot - Comparaison WS - Time T0 vs T1 - P.Value"))
ggsave(paste0(my_id,'-Volcano-plot-Comparaison-WS-Time-P-Value.pdf'))
...
full_results_WR %>% 
  ...
  geom_vline(xintercept = c(-fc_cutoff, fc_cutoff),
             linetype = "dashed")+
  scale_color_manual(values=c("grey", "blue", "gold"))+
  labs(title=paste0(my_id, " - Volcano plot - Comparaison WR - Time T0 vs T1 - Adj.P.Value"))
ggsave(paste0(my_id,'-Volcano-plot-Comparaison-WR-Time-Adj-P-Value.pdf'))
...
full_results_WR %>% 
  ...
  geom_vline(xintercept = c(-fc_cutoff, fc_cutoff),
             linetype = "dashed")+
  scale_color_manual(values=c("grey", "blue", "gold"))+
  labs(title=paste0(my_id, " - Volcano plot - Comparaison WR - Time T0 vs T1 - P.Value"))
ggsave(paste0(my_id,'-Volcano-plot-Comparaison-WR-Time-P-Value.pdf'))
...
full_results_NW %>% 
  ...
  geom_vline(xintercept = c(-fc_cutoff, fc_cutoff),
             linetype = "dashed")+
  scale_color_manual(values=c("grey", "blue", "gold"))+
  labs(title=paste0(my_id, " - Volcano plot - Comparaison NW - Time T0 vs T1 - Adj.P.Value"))
ggsave(paste0(my_id,'-Volcano-plot-Comparaison-NW-Time-Adj-P-Value.pdf'))
...
full_results_NW %>% 
  ...
  geom_vline(xintercept = c(-fc_cutoff, fc_cutoff),
             linetype = "dashed")+
  scale_color_manual(values=c("grey", "blue", "gold"))+
  labs(title=paste0(my_id, " - Volcano plot - Comparaison NW - Time T0 vs T1 - P.Value"))
ggsave(paste0(my_id,'-Volcano-plot-Comparaison-NW-Time-P-Value.pdf'))
...
full_results_WS %>% 
  ...
  geom_vline(xintercept = c(-fc_cutoff, fc_cutoff),
             linetype = "dashed")+
  scale_color_manual(values=c("grey", "blue", "gold"))+
  labs(title=paste0(my_id, ' - Volcano plot - WS - Time T0 vs T1 - Top ',topN,' genes - Adj.P.Value'))
ggsave(paste0(my_id,'-Volcano-Comparaison-WS-Time-Top20-plot-Adj-P-Value.pdf'))
...
full_results_WS %>% 
  ...
  geom_vline(xintercept = c(-fc_cutoff, fc_cutoff),
             linetype = "dashed")+
  scale_color_manual(values=c("grey", "blue", "gold"))+
  labs(title=paste0(my_id, ' - Volcano plot - WS - Time T0 vs T1 - Top ',topN,' genes - P.Value'))
ggsave(paste0(my_id,'-Volcano-Comparaison-WS-Time-Top20-plot-P-Value.pdf'))
...
full_results_WR %>% 
  ...
  geom_vline(xintercept = c(-fc_cutoff, fc_cutoff),
             linetype = "dashed")+
  scale_color_manual(values=c("grey", "blue", "gold"))+
  labs(title=paste0(my_id, ' - Volcano plot - WR - Time T0 vs T1 - Top ',topN,' genes - Adj.P.Value'))
ggsave(paste0(my_id,'-Volcano-Comparaison-WR-Time-Top20-plot-Adj-P-Value.pdf'))
...
full_results_WR %>% 
  ...
  geom_vline(xintercept = c(-fc_cutoff, fc_cutoff),
             linetype = "dashed")+
  scale_color_manual(values=c("grey", "blue", "gold"))+
  labs(title=paste0(my_id, ' - Volcano plot - WR - Time T0 vs T1 - Top ',topN,' genes - P.Value'))
ggsave(paste0(my_id,'-Volcano-Comparaison-WR-Time-Top20-plot-P-Value.pdf'))
...
full_results_NW %>% 
  ...
  geom_vline(xintercept = c(-fc_cutoff, fc_cutoff),
             linetype = "dashed")+
  scale_color_manual(values=c("grey", "blue", "gold"))+
  labs(title=paste0(my_id, ' - Volcano plot - NW - Time T0 vs T1 - Top ',topN,' genes - Adj.P.Value'))
ggsave(paste0(my_id,'-Volcano-Comparaison-NW-Time-Top20-plot-Adj-P-Value.pdf'))
...
full_results_NW %>% 
  ...
  geom_vline(xintercept = c(-fc_cutoff, fc_cutoff),
             linetype = "dashed")+
  scale_color_manual(values=c("grey", "blue", "gold"))+
  labs(title=paste0(my_id, ' - Volcano plot - NW - Time T0 vs T1 - Top ',topN,' genes - P.Value'))
ggsave(paste0(my_id,'-Volcano-Comparaison-NW-Time-Top20-plot-P-Value.pdf'))
...
full_results_WS %>% 
  ...
  labs(title="Volcano plot - WS - Time T0 vs T1 - 20 genes of tolerance (Baron et al. 2015) - Adj.P.Value")
ggsave(paste0(my_id,'-Volcano-plot-Comparaison-WS-Time-20-genes-TOL-Adj-P-Value.pdf'))
...
full_results_WS %>% 
  ...
  scale_color_manual(values=c("grey", "blue", "gold")) + 
  geom_text_repel(col = "black", max.overlaps = 5000) +
  labs(title="Volcano plot - WS - Time T0 vs T1 - 20 genes of tolerance (Baron et al. 2015) - P.Value")
ggsave(paste0(my_id,'-Volcano-plot-Comparaison-WS-Time-20-genes-TOL-P-Value.pdf'))
...
full_results_WR %>% 
  ...
  scale_color_manual(values=c("grey", "blue", "gold")) + 
  geom_text_repel(col = "black", max.overlaps = 5000) +
  labs(title="Volcano plot - WR - Time T0 vs T1 - 20 genes of tolerance (Baron et al. 2015) - Adj.P.Value")
ggsave(paste0(my_id,'-Volcano-plot-Comparaison-WR-Time-20-genes-TOL-Adj-P-Value.pdf'))
...
full_results_WR %>% 
  ...
  scale_color_manual(values=c("grey", "blue", "gold")) + 
  geom_text_repel(col = "black", max.overlaps = 5000) +
  labs(title="Volcano plot - WR - Time T0 vs T1 - 20 genes of tolerance (Baron et al. 2015) - P.Value")
ggsave(paste0(my_id,'-Volcano-plot-Comparaison-WR-Time-20-genes-TOL-P-Value.pdf'))
...
full_results_NW %>% 
  ...
  scale_color_manual(values=c("grey", "blue", "gold")) + 
  geom_text_repel(col = "black", max.overlaps = 5000) +
  labs(title="Volcano plot - NW - Time T0 vs T1 - 20 genes of tolerance (Baron et al. 2015) - Adj.P.Value")
ggsave(paste0(my_id,'-Volcano-plot-Comparaison-NW-Time-20-genes-TOL-Adj-P-Value.pdf'))
...
full_results_NW %>% 
  ...
  scale_color_manual(values=c("grey", "blue", "gold")) + 
  geom_text_repel(col = "black", max.overlaps = 5000) +
  labs(title="Volcano plot - NW - Time T0 vs T1 - 20 genes of tolerance (Baron et al. 2015) - P.Value")
ggsave(paste0(my_id,'-Volcano-plot-Comparaison-NW-Time-20-genes-TOL-P-Value.pdf'))
...
## Out of date
## ESSAI AVEC LES MOYENNES D'EXPRESSION
## Analyse T0 vs T1 pour WR, WS et NW
