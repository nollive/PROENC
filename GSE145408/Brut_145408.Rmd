...
annotations <- sampleInfo[, c("Group", "Time")]
...
features %>% 
  rename(features, GENE_SYMBOL = SYMBOL,
         GENE_TITLE = GENENAME)
...
#il y a No withdrawal (NW), withrawal stable (WS) et withdrawal rejection (WR)
...
save_pheatmap_pdf(heatmap_6_genes, paste0('GSE_',my_id,'_heatmap_20_genes.pdf'))
```
